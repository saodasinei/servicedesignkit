                          ...
                          success: function(tn){
                            ...
                            if(value.length>0 && tn.tns.length>0){
                             ...
                             setTimeout(function(){
                              ...
                              +"<div>"
                              +"<span class='srobot-content'>"
                              +"I don't find related technqiues, please type a key word again"
                              +"<div class='suserinput'>"
             ...
             $("#scontent").on("click",".st-rc", function(){
                          ...
                          setTimeout(function(){
                             ...
                             $("#scontent").append( 
                               ...
                               +"<img src='../icons/Timo.jpg' class='profile'>"
                               +"<span class='robot-content'>"
                               +"Ok. In the following, I’ll ask you some multiple choice questions to guide you finding design techniques for your project.</br>"
